...
export default function PastorCourseEditorPage() {
  ...
  if (!course || !modules) {
    return (
      <PastorLayout title="Editor de Curso">
  ...
  return (
    <PastorLayout
      ...
      actions={
        <button
          onClick={() => navigate("/pastor/cursos")}
          ...
          <li key={lesson._id} className="px-5 py-3">
            {editingLessonId === lesson._id ? (
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <button
                    onClick={() => navigate(`/pastor/cursos/${courseId}/aulas/${lesson._id}/quiz`)}
