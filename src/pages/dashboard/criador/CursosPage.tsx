  ...
  return (
    <div className={cn('overflow-hidden p-5 transition-all duration-200 hover:border-white/14 hover:bg-white/[0.05]', brandPanelClass)}>
      ...
      <div className="mt-5 flex gap-3">
        ...
        <Link
          to={`/dashboard/cursos/${course._id}/metricas`}
          className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm font-semibold text-white/72 transition-colors duration-200 hover:border-[#F37E20]/30 hover:bg-[#F37E20]/8 hover:text-[#F2BD8A]"
          title="Ver métricas por aula"
          aria-label="Ver métricas por aula"
        >
