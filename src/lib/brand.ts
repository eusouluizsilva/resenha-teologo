...
export const brandInputClass =
  'w-full rounded-2xl border border-white/10 bg-[#10161E] px-4 py-3 text-sm text-white placeholder-white/28 transition-all duration-200 focus:border-[#F37E20]/55 focus:bg-[#121B25] focus:outline-none focus:ring-4 focus:ring-[#F37E20]/10'

export const brandInputLightClass =
  'w-full rounded-2xl border border-[#DED4C7] bg-white px-4 py-3 text-sm text-[#111827] placeholder-[#7A8390] transition-all duration-200 focus:border-[#F37E20]/55 focus:outline-none focus:ring-4 focus:ring-[#F37E20]/10'
