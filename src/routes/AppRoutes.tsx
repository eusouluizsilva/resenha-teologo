// Mapeamento path → component da plataforma. Mantido em arquivo dedicado
// pra que App.tsx contenha apenas o chrome global (BrowserRouter, banners,
// Suspense). Adicionar uma rota nova significa: import lazy em lazyPages.ts
// (se for code-split) e uma <Route> aqui.
